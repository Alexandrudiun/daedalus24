    ...
    export default {
      ...
      data() {
        return {
          ...
          stepCount: 0,
          path: [],
          showCompletionPopup: false, // Pop-up control pentru animație
        };
      },
      methods: {
        async fetchMazeData() {
...
>>>>>>> Stashed changes
          ...
          console.log("Parsed dimensions:", sizeX, sizeY); 
    ...
    .popup-content {
    background-image: url('../assets/popup_bacc.jpeg'); /* Înlocuiește cu calea corectă a imaginii */
    ...
    width: 100%;
    text-align: center;
    color: white; /* Schimbă culoarea textului pentru a se vedea pe fundal */
}
    
    .congratulations-text {
        font-family: "Jacquard 12", system-ui;
        font-size: 2em; /* Mărirea dimensiunii textului */
        margin: 0;
    }
